...
public class OnsiteReshelveReport {
    ...
    public List<OnsiteReshelveReport.ReshelveEntry> generateReshelveReport() {
        List<OnsiteReshelveReport.ReshelveEntry> reportList = new ArrayList<>();
        ...
        try (Connection conn = DBConnection.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                reportList.add(new OnsiteReshelveReport.ReshelveEntry(itemName, itemCode, totalQuantity));
            }
